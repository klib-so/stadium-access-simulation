...
stadium_env = simpy.RealtimeEnvironment(initial_time=cfg.start_time, factor=.008, strict=False)  # Small factors increase the speed. Turning strict off allows very small values.
